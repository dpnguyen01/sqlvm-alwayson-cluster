...
- This module has been renamed to SqlServerDsc. Development of these resources will continue under that module.
  This specific module (xSQLServer) is now deprecated and use of SqlServerDsc is recommended.
  The only change between version 9.0.0.0 and 9.1.0.0 is the addition of this note to the description of the module.
